...
fetch('http://192.168.1.64:3000/user')
...
const priorities = ref([
  { title: 'Infinite', value: 10000 },
  { title: 'Very urgent', value: 5 },
  { title: 'Urgent', value: 4 },
  { title: 'Normal', value: 3 },
  { title: 'On the occasion', value: 2 },
...
<template>
  ...
  >
    <div v-if="props.item !== undefined" class="relative w-full max-w-2xl max-h-full">
      <!-- Modal content -->
      <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
        <!-- Modal header -->
        <div class="flex items-start justify-between p-5 border-b border-gray-200 rounded-t dark:border-gray-600">
        ...
        <form @submit.prevent="submitForm(props.submitMethod)">
          ...
          <div class="p-6 space-y-6">
            ...
            <div class="mb-5">
              ...
              <select v-model="props.item.priority" id="priority" name="priority">
            ...
            <label class="inline-flex mb-5 cursor-pointer">
              <input type="checkbox" v-model="props.item.recurrent" value="" class="sr-only peer" />
              <div
              ...
              <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300"
                >{{ t('modaltodo.form.recurrent') }}</span
              >
            </label>

            <div class="mb-5">
              <label for="assignedTo" class="label">{{ t('modaltodo.form.assignedTo') }}</label>
              <select v-model="props.item.assignedTo" id="assignedTo">
